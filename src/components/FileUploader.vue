...
<template>
  <div class="file-uploader">
    <input :id="fileInputId" type="file" :accept="accept" class="file-uploader__input"
      @change="handleFileInputChange" />

    <button type="button" class="file-uploader__button" data-testid="file-upload-btn"
      :class="{ 'has-error': hasError, 'has-file': hasFile && !hasError }" @click="triggerFileInput">
      <svg v-if="hasNoError" class="file-uploader__icon" xmlns="http://www.w3.org/2000/svg" fill="none"
        viewBox="0 0 24 24" stroke="currentColor">
        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
          d="M7 16a4 4 0 01-.88-7.903A5 5 0 1115.9 6L16 6a5 5 0 011 9.9M15 13l-3-3m0 0l-3 3m3-3v12" />
      </svg>

      <svg v-else-if="hasError" class="file-uploader__icon file-uploader__icon--error"
        xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
          d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
      </svg>

      <svg v-else-if="isValidating" class="file-uploader__icon file-uploader__icon--spinner"
      ...
      <svg v-else class="file-uploader__icon file-uploader__icon--success" xmlns="http://www.w3.org/2000/svg"
      ...
      <span v-else class="file-uploader__text">
        ...
        <span class="file-uploader__details">{{ keyCount }} {{ t('upload.keys') }} • {{ fileSizeKB }} KB</span>
      </span>
    </button>
  </div>
</template>
